 ...
 */
public abstract class LlamaLangParserBase extends Parser
{
    protected LlamaLangParserBase(TokenStream input) {
        super(input);
    }
    ...
    protected boolean lineTerminatorAhead() {
        ...
        return (type == LlamaLangLexer.COMMENT && (text.contains("\r") || text.contains("\n"))) ||
