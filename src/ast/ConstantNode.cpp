...
static std::vector<std::string> contantTypesNames = {
  ...
  GET_NAME(CONSTANT_TYPE, CONSTANT_TYPE::U8),
  GET_NAME(CONSTANT_TYPE, CONSTANT_TYPE::U16),
  GET_NAME(CONSTANT_TYPE, CONSTANT_TYPE::U32),
  GET_NAME(CONSTANT_TYPE, CONSTANT_TYPE::U64),
...
static std::unordered_map<std::string, CONSTANT_TYPE> contantTypes = {
  ...
  SET_VAL(CONSTANT_TYPE, CONSTANT_TYPE::U8),
  SET_VAL(CONSTANT_TYPE, CONSTANT_TYPE::U16),
  SET_VAL(CONSTANT_TYPE, CONSTANT_TYPE::U32),
  SET_VAL(CONSTANT_TYPE, CONSTANT_TYPE::U64),
